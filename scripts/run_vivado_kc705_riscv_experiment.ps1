param(
    ...
    [int]$Jobs = 4,
    [string]$ExperimentName = "kc705_riscv_200mhz",
...
& $VivadoBat -mode batch -log (Join-Path $experimentRoot "vivado.log") -journal (Join-Path $experimentRoot "vivado.jou") -source fpga\vivado\tcl\run_kc705_riscv_200mhz_direct.tcl
exit $LASTEXITCODE
